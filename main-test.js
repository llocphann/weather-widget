...
//       }; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; line-height: 1.5; font-size: ${
//         this.settings.fontSize
//       }; height: auto; max-height: 550px;">
//         <h2 style="font-size: 1.8em; color: ${this.settings.temperatureColor}; font-weight: bold; margin-bottom: 15px; text-align: ${
//         this.settings.temperatureAlignment
//       };">
//           <img src="${weatherIcon}" alt="${description}" style="width: 80px; height: 80px;"/>
//           <div>
//             <strong style="font-size: 2.5em; color: ${this.settings.temperatureColor}; text-align: ${
//         this.settings.temperatureAlignment
//       };">${temperature}°${this.settings.units === "metric" ? "C" : "F"}</strong>
...
//         this.settings.feelsLikeAlignment
...
//               ? `<p style="margin: 0; font-size: 0.95em; color: ${this.settings.minMaxColor}; text-align: ${this.settings.minMaxAlignment}">🌡️ Min: ${tempMin}° | Max: ${tempMax}°</p>`
//               : ""
//           }
//           ${
//             this.settings.showHumidity
//               ? `<p style="margin: 0; font-size: 0.95em; color: ${this.settings.humidityColor}; text-align: ${this.settings.humidityAlignment}">💧 Humidity: ${humidity}%</p>`
//               : ""
//           }
//           ${
//             this.settings.showWind
//               ? `<p style="margin: 0; font-size: 0.95em; color: ${this.settings.windColor}; text-align: ${
//                   this.settings.windAlignment
//                 }">💨 Wind: ${windSpeed} ${this.settings.units === "metric" ? "m/s" : "mph"}</p>`
//               : ""
//           }
//           ${
//             this.settings.showSunriseSunset
//               ? `<p style="margin: 0; font-size: 0.95em; color: ${this.settings.sunriseSunsetColor}; text-align: ${this.settings.sunriseSunsetAlignment}">🌅 Sunrise: ${sunrise} | 🌇 Sunset: ${sunset}</p>`
//               : ""
//           }
//         </div>
//       </div>
